...
var _elementsCard = require("./modules/elementsCard");
...
const runWildberriesApplication = async ()=>{
    ...
    function createCardsProduct(idProductCard, ProductFoto, titleCard, categoryCard, descriptionCard, priceProduct) {
        const cardProductItem = _elementsCard.createDivId("card-product_item", idProductCard);
        const cardProductPopUp = _elementsCard.createA("card-product_pop-up");
        const cardProductImage = _elementsCard.createDiv("card-product_image");
        const ProductImage = _elementsCard.creatImg("img", ProductFoto, "Image");
        const scaleProduct = _elementsCard.createDiv("scale-product");
        const textScaleProduct = _elementsCard.createP("text-scale_product", "\u0423\u0432\u0435\u043B\u0438\u0447\u0438\u0442\u044C \u043A\u0430\u0440\u0442\u0438\u043D\u043A\u0443");
        const cardProductInformation = _elementsCard.createDiv("card-product_information");
        const cardProductTitle = _elementsCard.createH3("card-product_title", titleCard);
        const cardProductCategory = _elementsCard.createH3("card-product_category", `\u{41A}\u{430}\u{442}\u{435}\u{433}\u{43E}\u{440}\u{438}\u{44F}: ${categoryCard}`);
        const cardProductDescription = _elementsCard.createP("card-product_description", descriptionCard);
        const cardroductPrice = _elementsCard.createP("card-product_price", `${priceProduct} \u{440}.`);
        const btnAddBasket = _elementsCard.createButtons("btn-add_basket", "\u0412 \u043A\u043E\u0440\u0437\u0438\u043D\u0443");
...
},{"./modules/elementsCard":"cmAkG"}],"cmAkG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createDivId", ()=>createDivId);
parcelHelpers.export(exports, "createDiv", ()=>createDiv);
parcelHelpers.export(exports, "createA", ()=>createA);
parcelHelpers.export(exports, "creatImg", ()=>creatImg);
parcelHelpers.export(exports, "createP", ()=>createP);
parcelHelpers.export(exports, "createH3", ()=>createH3);
parcelHelpers.export(exports, "createButtons", ()=>createButtons);
const createDivId = (classList, textContent)=>{
...
const createA = (classList)=>{
    const element = document.createElement("a");
    element.classList.add(classList);
    return element;
};
const creatImg = (classList, src, alt)=>{
...
const createP = (classList, textContent)=>{
    const element = document.createElement("p");
    element.classList.add(classList);
    element.textContent = textContent;
    return element;
};
const createH3 = (classList, textContent)=>{
    const element = document.createElement("p");
    element.classList.add(classList);
    element.textContent = textContent;
    return element;
};
const createButtons = (classList, textContent)=>{
...
},{}]},["aJ0Tr","fFaKF"], "fFaKF", "parcelRequireaad3")
